          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-4 bg-gray-900 dark:bg-gradient-to-r dark:from-primary-600 dark:to-primary-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
                  <CheckCircle className="w-5 h-5" />
                  <span>{t("profile.setup.btn.finish")}</span>
                </button>
              </div>
            </form>
          )}
