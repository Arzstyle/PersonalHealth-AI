      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-10 pt-4 gap-6">
        <div>
          ...
          <p className="text-gray-500 mt-2 ml-1">
            Kelola informasi dan preferensi akunmu.
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={idx}
                className="bg-white/70 backdrop-blur p-4 rounded-2xl border border-white/60 shadow-sm hover:-translate-y-1 transition-transform"
              >
                <div
                  className={`w-10 h-10 ${stat.bg} rounded-xl flex items-center justify-center ${stat.color} mb-3`}
                >
                ...
                <div className="flex flex-wrap gap-2">
                  {user.dietaryRestrictions.length > 0 ? (
                    user.dietaryRestrictions.map((item, index) => (
                      <span
                        key={index}
                        className="px-3 py-1.5 rounded-lg bg-green-50 text-green-700 font-bold text-xs border border-green-100"
                      >
                        {item}
                      </span>
                    ))
                ...
                <div className="flex flex-wrap gap-2">
                  {user.allergies.length > 0 ? (
                    user.allergies.map((item, index) => (
                      <span
                        key={index}
                        className="px-3 py-1.5 rounded-lg bg-red-50 text-red-700 font-bold text-xs border border-red-100"
                      >
                        {item}
                      </span>
                    ))
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
                      />
                    </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      value={formData.goal}
                      onChange={handleInputChange}
                      className="w-full p-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-red-500 outline-none bg-white"
                    >
                      {GOALS.map((g) => (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      *Disarankan update otomatis jika mengubah aktivitas.
                    </p>
                  </div>
                </div>
              )}
